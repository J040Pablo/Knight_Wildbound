...
namespace Roguelite.Core
{
    public class SpawnManager : MonoBehaviour
    {
        ...
        public bool SpawnHorse(GameObject horse)
        {
            ...
            Vector3 targetPosition = new Vector3(-4f, 0.5f, 2f);
            Quaternion targetRotation = Quaternion.identity;
